...
#samples <- list.files("rsem_trimmed_dedup_nextera") #Hier sollten isoforms sein! nicht dedup nextera!
...
```{r}
#Convert list a DEG's into a format that you can upload into DAVID.
#Think of what cluster of genes we want to analyze!
write.table(meta_genes[meta_genes$ensembl_gene_id_version %in% names(which(cl_DEG==2)), "ensembl_gene"],
file = "genes_C2.txt",
quote = F, row.names = F, col.names = F) #DEG's
