...
samples <- samples[seq(1, length(samples),by=2)] #remove the isoform files
#samples
...
avg_expr_aDR$ensembl_gene_id_version <- test$ensembl_gene_id_version

#max_treatment_DEG <- setNames(colnames(avg_expr_aDR)[apply(test$ensembl_gene_id_version[DEG_aDR,], 1, which.max)],DEG_aDR)

max_treatment_DEG <- setNames(test$ensembl_gene_id_version[apply(test$ensembl_gene_id_version, 1, which.max)],DEG_aDR) 
