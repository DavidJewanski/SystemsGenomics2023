...
print(setdiff(colnames(meta2),colnames(meta1)))
...
meta_genes <- getBM(attributes = c("ensembl_gene_id",
                    ...
                    mart = ensembl) %>%
  right_join(data.frame(ensembl_gene_id_version = rownames(expr)), by = "ensembl_gene_id_version") %>%                                                                                                                                       by = "ensembl_gene_id_version") %>%
